...
# metadata
metadata = {
    'protocolName': 'Station A - TurboBeads - Sample and lysis dispensing',
    ...
    'apiLevel': '2.6',
    'description': 'Protocol for TurboBeads sample and lysis dispensing'
}
...
extra_dispensal         = 1
run_id                  = 'A-TurboBeads-Dispensacion_muestras_y_lisis'
