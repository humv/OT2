...
def run(protocol: protocol_api.ProtocolContext):
    ...
    wellplate9 = protocol.load_labware('kingfisher_96_aluminumblock_200ul', '9')
    mag_mod = protocol.load_module('Magnetic Module Gen2', '10')
    wellplate10 = mag_mod.load_labware('kingfisher_96_wellplate_2000ul')
    ...
    for elution2 in range(NUM_ROWS):
        p300multi.pick_up_tip()
        p300multi.well_bottom_clearance.dispense = 5
