...
def run(ctx: protocol_api.ProtocolContext):
    ...
    STEPS = { #Dictionary with STEP activation, description, and times
         ...
         3:{'Execute': True, 'description': 'Wait rest', 'wait_time': 300},# 300
         4:{'Execute': True, 'description': 'Incubate wait with magnet ON', 'wait_time': WAIT_MAGNET}, #600
         ...
         8:{'Execute': True, 'description': 'Incubate wait with magnet ON', 'wait_time': WAIT_MAGNET},#300
        ...
        12:{'Execute': True, 'description': 'Incubate wait with magnet ON', 'wait_time': WAIT_MAGNET},#300
        13:{'Execute': True, 'description': 'Remove supernatant'},#
        14:{'Execute': True, 'description': 'Allow to dry', 'wait_time': WAIT_MAGNET},#600
        15:{'Execute': True, 'description': 'Switch off magnet'},#
        16:{'Execute': True, 'description': 'Add ELUTION'},#
        17:{'Execute': True, 'description': 'Wait rest', 'wait_time': 600},#60
        18:{'Execute': True, 'description': 'Incubate wait with magnet ON', 'wait_time': WAIT_MAGNET},#300
