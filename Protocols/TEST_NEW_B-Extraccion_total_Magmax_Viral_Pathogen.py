...
def run(ctx: protocol_api.ProtocolContext):
    ...
    STEPS = { #Dictionary with STEP activation, description, and times
            1:{'Execute': False, 'description': 'Mezclar en deepwell'},
            2:{'Execute': False, 'description': 'Espera', 'wait_time': 300},         # TODO: Ver si es necesaria
            3:{'Execute': False, 'description': 'Incubación con el imán ON', 'wait_time': 600},
            4:{'Execute': False, 'description': 'Desechar sobrenadante'},
            5:{'Execute': False, 'description': 'Imán OFF'},
            6:{'Execute': True, 'description': 'Transferir primer lavado'},
            7:{'Execute': False, 'description': 'Incubación con el imán ON', 'wait_time': 300},
            8:{'Execute': False, 'description': 'Desechar sobrenadante'},
            9:{'Execute': False, 'description': 'Imán OFF'},
            10:{'Execute': False, 'description': 'Transferir segundo lavado'},
            11:{'Execute': False, 'description': 'Incubación con el imán ON', 'wait_time': 300},
            12:{'Execute': False, 'description': 'Desechar sobrenadante'},
            13:{'Execute': False, 'description': 'Secado', 'wait_time': 180}, # 180 - 600
            14:{'Execute': False, 'description': 'Imán OFF'},
            15:{'Execute': False, 'description': 'Transferir elución'},              # TODO: No migrada la espera de 10 mins después de este paso
            16:{'Execute': False, 'description': 'Incubación con el imán ON', 'wait_time': 180}, # 180 - 600
            17:{'Execute': False, 'description': 'Transferir elución a la placa'},
            }
